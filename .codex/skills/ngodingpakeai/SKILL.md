...
- Workspace ID: `7958e21b-5a4e-4f6b-95aa-7a20cb6a1c0e`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/7958e21b-5a4e-4f6b-95aa-7a20cb6a1c0e.
...
2. `npx ngodingpakeai connect --workspace 7958e21b-5a4e-4f6b-95aa-7a20cb6a1c0e --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/7958e21b-5a4e-4f6b-95aa-7a20cb6a1c0e. Only pass on links the CLI actually printed — never assemble one from an id yourself.
