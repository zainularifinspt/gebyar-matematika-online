...
export const MOCK_KATEGORI: KategoriLomba[] = [
  {
    ...
    kuota: 500,
    terdaftar: 0,
    jadwalPenyisihan: '24 Oktober 2026, 08:30 - 10:30 WIB',
    jadwalFinal: '07 November 2026, 09:00 - 11:30 WIB',
  ...
  },
  {
    ...
    kuota: 600,
    terdaftar: 0,
    jadwalPenyisihan: '24 Oktober 2026, 13:00 - 15:00 WIB',
    jadwalFinal: '07 November 2026, 13:00 - 15:30 WIB',
  ...
  },
  {
    ...
    kuota: 600,
    terdaftar: 0,
    jadwalPenyisihan: '25 Oktober 2026, 09:00 - 11:30 WIB',
    jadwalFinal: '08 November 2026, 09:00 - 12:00 WIB',
    ...
    hadiah: [
      'Juara 1: Trofi Bergilir Rektor + Uang Pembinaan Rp 7.500.000 + Golden Ticket Masuk Prodi Matematika',
...
export const MOCK_PENGUMUMAN: Pengumuman[] = [
  {
    id: 'ann-1',
    judul: 'Pendaftaran Gelombang 1 Gebyar Matematika 2026 Resmi Dibuka!',
    ringkasan: 'Dapatkan diskon biaya early-bird untuk 100 pendaftar pertama dari seluruh Indonesia.',
    isi: 'Panitia Gebyar Matematika mengumumkan bahwa pendaftaran resmi dibuka mulai hari ini. Peserta mandiri dan sekolah dapat langsung mendaftarkan peserta dengan konfirmasi instan via Midtrans (QRIS & Virtual Account).',
  ...
  {
    id: 'ann-3',
    judul: 'Perilisan Arsip Soal dan Pembahasan Resmi Tahun 2024 & 2023',
...
export const MOCK_KARTU_PESERTA: KartuPeserta = {
  ...
  sesi: 'Sesi 1 (Pagi)',
  qrCodeUrl: 'https://api.qrserver.com/v1/create-qr-code/?size=160x160&data=GM26-SMA-0142',
  fileUrl: '#',
};
...
export const MOCK_TEMPLATE_DOKUMEN: TemplateDokumenItem[] = [
  {
    id: 'tpl-001',
    jenis: 'sertifikat',
    nama: 'Template E-Sertifikat Juara & Peserta GM 2026 (Resmi)',
    fileUrl: 'https://images.unsplash.com/photo-1606326608606-aa0b62935f2b?w=1200&auto=format&fit=crop&q=80',
    aktif: true,
    diunggahOleh: 'Super Admin / Ketua Panitia',
    tanggalUnggah: '01 Sep 2026',
    layoutJson: {
  ...
  },
  {
    ...
    aktif: true,
    diunggahOleh: 'Divisi Kesekretariatan',
    tanggalUnggah: '05 Sep 2026',
    layoutJson: {
...
export const MOCK_GURU_PROFILE: GuruProfileData = {
  ...
  suratTugasUrl: 'https://example.com/docs/surat-tugas-pembimbing-2026.pdf',
};
