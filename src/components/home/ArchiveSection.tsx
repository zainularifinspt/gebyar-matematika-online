  ...
  return (
    <section id="arsip" className="py-20 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 p-4 rounded-2xl glass-3d-base border border-white/90 shadow-sm mb-8">
        ...
        {/* 3D Glass Document Preview Modal */}
        {previewItem && (
